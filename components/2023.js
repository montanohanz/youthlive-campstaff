...
function CTA(props) {
    return (
        <div class="container mx-auto text-center">
            <div class="container" name="banner">
                <div class="shadow-md">
                    <p class="text-xl">call to action</p>
                    <p class="text-base">button</p>
                </div>
            </div>
        </div>
    );
...
function Footer(props) {
    return (
        <footer>
            <div class="flex flex-row bg-slate-800 text-right justify-end">
            <div class="grid gap-1 grid-cols-2 grid-rows-1 text-white justify-items-end">
                <img class="w-24" src="./assets/img/gcf-logo-white.png"/>
                <div class="mr-2 align-bottom">
