/*
  ...
  - Made the column `contact` on table `Camper` required. This step will fail if there are existing NULL values in that column.
  - Made the column `email` on table `Camper` required. This step will fail if there are existing NULL values in that column.
